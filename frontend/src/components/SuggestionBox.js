      ...
      <div className="w-full lg:w-1/2 space-y-6 overflow-y-auto max-h-screen pr-2">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <button
            ...
            className="mt-4 w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-medium rounded-lg transition"
          >
        ...
        <div className="bg-white rounded-xl p-6 h-[calc(100vh-3rem)] flex flex-col">
          ...
          {suggestion ? (
            <>
              ...
              <button
                onClick={exportToPDF}
                className="py-3 px-6 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition flex items-center justify-center gap-2 shadow"
              >
                📄 Download as PDF
              </button>
            </>
